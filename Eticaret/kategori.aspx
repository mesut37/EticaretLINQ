<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kategori.aspx.cs" Inherits="kategori" %>
            ...
            <div class="leftBlock">
                ...
                <div class="Block_item KategoriFilitrelemeContent">
                    ...
                    <div class="Block_Text KategoriFilitrelemeTxt">
                                ...
                                <table id="mainHolder_ctl00_chkMarkalar">
                                    <tbody>
                                        ...
                                        <asp:Repeater runat="server" ID="rptAltKategoriler">
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="solkategori"><a href="/kategori/<%#Eval("ID")%>/<%#Tools.UrlSeo(Eval("KategoriAdi").ToString().ToLower()) %>" class="kategori">
                        ...
                        <div class="KategoriFilitreleme" runat="server" visible="false">
                ...
                <div class="categoryTitle">
                    <div class="categoryTitleText">
                        <h1>
                            ...
                            <asp:Literal ID="ltrKategoriNav" runat="server"></asp:Literal></h1>
                    </div>
                    <div id="mainHolder_divSayfalamaUst" class="urunListRel">
                        <script type="text/javascript">
                            $(document).ready(function () {
                                $(".selectBox").click(function () {
                                    ...
                                    $(this).find(".selectBoxText").text(str);
                                });
                        ...
                        <div class="brandlistselection">
                            <div>
                                ...
                                <asp:DropDownList ID="drpAltKategoriler" OnSelectedIndexChanged="drpAltKategoriler_SelectedIndexChanged" AutoPostBack="true" class="brandSelectbox KategoriSelectBox" runat="server">
                                </asp:DropDownList>
                            </div>
                            <div>

                                <asp:DropDownList ID="drpMarkalar" OnSelectedIndexChanged="drpMarkalar_SelectedIndexChanged1" AutoPostBack="true" class="brandSelectbox KategoriSelectBox" runat="server">
                                </asp:DropDownList>
                            </div>

                            <div>

                                <asp:DropDownList ID="drpFiyataGoreListe" OnSelectedIndexChanged="drpFiyataGoreListe_SelectedIndexChanged" AutoPostBack="true" class="brandSelectbox KategoriSelectBox" runat="server">

                                    <asp:ListItem Value="asc">Fiyata Göre Artan</asp:ListItem>
                                    <asp:ListItem Value="desc">Fiyata Göre Azalan</asp:ListItem>
                                </asp:DropDownList>
                            </div>

                            <div class="blockSelect">
                                <a href="javascript:;" class="sort_hrz"></a>
                                <a href="javascript:;" class="sort_3"></a>
                                <a href="javascript:;" class="sort_4"></a>
                            </div>
                        </div>
                        <div class="pageNumber">
                            <div class="pageNumberContent">

                                <a class="SelectedSayfa" href="#">1</a>

                                <a class="" href="kampanyali-urunler2f9b.html?Sayfa=2">2</a>

                                <a class="" href="kampanyali-urunler6cb3.html?Sayfa=3">3</a>

                                <a class="" href="kampanyali-urunler342d.html?Sayfa=4">4</a>

                                <a class="" href="#">...</a>

                                <a class="" href="kampanyali-urunlerd3de.html?Sayfa=155">155</a>

                                <a class="" href="kampanyali-urunler2f9b.html?Sayfa=2">&gt;</a>
