...
public partial class firsaturunleri : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            var yeniUrunler = from u in db.ETICARET_Urunlers.Where(m => m.Firsat == 1 & m.Durum == 1) select u;
            ...
            Page.Title = "Yeni Ürünler" + " " + cons.title;
            Page.MetaDescription = "Yeni Ürünler" + " " + cons.description;
            Page.MetaKeywords = "Yeni Ürünler" + " " + cons.keywords;
