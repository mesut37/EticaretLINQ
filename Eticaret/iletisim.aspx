        ...
        <div id="divIcerik" class="ticiContainer homeContainer">
            ...
            <div class="centerCount">
                ...
                <div class="categoryTitleText">
                    <br />
                    <h1 style="font-size: 22px; font-weight: bold;">İletişim Bilgileri</h1>
                </div>
                <span class="iletisimblok">Firma Adı : <asp:Literal ID="ltrFirmaAdi" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">Yetkili Kişi : <asp:Literal ID="ltrYetkili" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">Adres : <asp:Literal ID="ltrAdres" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">Telefon : <asp:Literal ID="ltrTelefon" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">Fax : <asp:Literal ID="ltrFax" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">E-mail : <asp:Literal ID="ltrEmail" runat="server"></asp:Literal>
                </span>
                <span class="iletisimblok">Vergi No : <asp:Literal ID="ltrVergiNo" runat="server"></asp:Literal>
                </span>

                  <div class="categoryTitleText">
                    <br />
                    <h1 style="font-size: 22px; font-weight: bold;">Bize Ulaşın</h1>
                </div>
                   <asp:TextBox ID="txtAdSoyad" Style="margin-bottom:10px;" placeholder="Ad Soyad" class="textbox" runat="server"></asp:TextBox>
                 <asp:TextBox ID="txtKonu" placeholder="Konu"  Style="margin-bottom:10px;" class="textbox" runat="server"></asp:TextBox>
                   <asp:TextBox ID="txtMesaj" placeholder="Mesaj" TextMode="MultiLine"  Height="200" Style="margin-bottom:10px;" class="textbox" runat="server"></asp:TextBox>
                <asp:Button ID="btnGonder" OnClick="btnGonder_Click" runat="server" Text="Gönder" class="button uyeol" />
