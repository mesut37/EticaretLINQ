                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="urunler.aspx">Tüm Ürünler</a></li>
                        </ul>
                    ...
                    <asp:Button ID="btnYeni" Style="width: 140px;" class="btn btn-success" runat="server" Text="Yeni Ürün Ekle" OnClick="btnYeni_Click" /><br />
                    <br />
                    <!-- SHOW HIDE COLUMNS -->
                    <div class="widget">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:Repeater runat="server" ID="rptUrunler" OnItemCommand="rptUrunler_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <img src="../Dosyalar/Urun/Mini/<%#Eval("Resim")%>" width="60" /></td>
                                                    <td style="width: 180px; text-align: left; margin-left: 10px;"><strong><%#Eval("UrunAdi")%></strong></td>
                                                    <td class="center"><%# string.Format("{0:c}",Eval("IndirimliFiyat"))%></td>
                                                    ...
                                                    <td class="center"><%#(Convert.ToInt32(Eval("Durum"))==1)?"<span class='aktifclass'>Aktif</span>":"<span class='pasifclass'>Pasif</span>"%></td>
                                                    <td class="center">
                                                        <asp:Button ID="btnDuzenle" CommandArgument='<%#Eval("ID")%>' CommandName="duzenle" Style="width: 100px;" class="btn btn-warning" runat="server" Text="Düzenle" />
                                                        <asp:LinkButton ID="LinkButton1" class="btn btn-warning sil" runat="server" OnClientClick="javascript:return confirm('Bu kayıt kalıcı olarak silinsin mi?');" CommandName="sil" Style="margin-left: -5px; height: 35px;" CommandArgument='<%#Eval("ID")%>'>Sil</asp:LinkButton>
                                                   
                                                          </td>
                                                    <td>
                                                        <a href="urunyorumlari.aspx?ID=<%#Eval("ID")%>"  class="btn btn-warning sil"  Style="margin-left: 5px;font-size:12px; height: 35px;">Yorumlar</a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
