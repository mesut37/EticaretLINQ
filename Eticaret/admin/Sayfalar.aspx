<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sayfalar.aspx.cs" Inherits="Sayfalar" %>
            ...
            <div class="container-fluid primary-content">
                ...
                <div class="primary-content-heading clearfix">
                    ...
                    <ul class="breadcrumb pull-left">
                        ...
                        <li><a href="sayfalar.aspx">Tüm Sayfalar</a></li>
                    </ul>
                    ...
                    <div class="widget-content">
                        ...
                        <div class="table-responsive">
                            <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                <thead>
                                    <tr>
                                        <th style="width: 700px;">Sayfa Adı</th>
                                        <th>Sıra</th>
                                        <th>Durum</th>
                                        <th>İşlem</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <asp:Repeater runat="server" ID="rptSayfalar" OnItemCommand="rptSayfalar_ItemCommand">
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align:left;padding-left:8px;"><strong><%#Eval("Baslik")%></strong></td>
                                                <td class="center"><%#Eval("Sira")%></td></td>
                                               ...
                                               <td class="center"><%#(Convert.ToInt32(Eval("Durum"))==1)?"<span class='aktifclass'>Aktif</span>":"<span class='pasifclass'>Pasif</span>"%></td>
                                                <td class="center">
                                                    ...
                                                    <asp:LinkButton ID="lnkSil" style="width: 40px;height:35px; margin-left: -8px;" CommandArgument='<%#Eval("ID")%>' CommandName="sil" OnClientClick="javascript:return confirm('Bu kayıt kalıcı olarak silinsin mi?');" class="btn btn-warning" runat="server">Sil</asp:LinkButton>
