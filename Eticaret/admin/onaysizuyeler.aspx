<%@ Page Language="C#" AutoEventWireup="true" CodeFile="onaysizuyeler.aspx.cs" Inherits="admin_onaysizuyeler" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="onaysizuyeler.aspx">Onaysız Üyeler</a></li>
                        </ul>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptUyeler" OnItemCommand="rptUyeler_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="text-align: left; padding-left: 8px;"><%#Eval("Ad")%> <%#Eval("Soyad")%></td>
                                                    <td><%#Eval("Email").ToString()%></td>
                                                    <td class="center"><%#Eval("Telefon")%></td>
                                                    <td class="center"><%#(Convert.ToInt32(Eval("Cinsiyet"))==1)?"Erkek":"Kadın"%></td>
                                                    <td class="center"><%#Eval("Sehir")%></td>
                                                    <td class="center"><%#Eval("EklenmeTarihi")%></td>

                                                    <td class="center">
                                                        <asp:Button ID="btnDuzenle" CommandArgument='<%#Eval("ID")%>' CommandName="duzenle" Style="width: 100px;" class="btn btn-warning" runat="server" Text="Üye Detay" />
