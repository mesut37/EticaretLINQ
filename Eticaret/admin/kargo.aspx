<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kargo.aspx.cs" Inherits="admin_kargo" %>
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:Repeater runat="server" ID="rptKargolar" OnItemCommand="rptKargolar_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    
                                                    <td style="text-align: left; padding-left: 8px;width:500px;"><strong><%#Eval("KargoAdi")%></strong></td>
