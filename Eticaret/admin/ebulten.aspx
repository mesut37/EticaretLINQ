<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ebulten.aspx.cs" EnableEventValidation="false" Inherits="admin_ebulten" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="ebulten.aspx">E-Bülten Kayıtları</a></li>
                        </ul>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptEBulten" OnItemCommand="rptEBulten_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
