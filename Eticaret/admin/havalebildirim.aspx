<%@ Page Language="C#" AutoEventWireup="true" CodeFile="havalebildirim.aspx.cs" Inherits="admin_havalebildirim" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="havalebildirim.aspx">Havale Bildirimleri</a></li>
                        </ul>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptHavaleBildirim" OnItemCommand="rptHavaleBildirim_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="text-align: left; padding-left: 8px;"><%#Eval("Tutar")%> TL</td>
                                                    <td style="width:500px;"><%#Eval("Notunuz").ToString()%></td>
                                                    <td class="center"><%#Eval("EklenmeTarihi")%>
                                                   

                                                    <td class="center">
                                                        <a href="siparisdetay.aspx?ID=<%#Eval("SiparisID")%>" class="btn btn-warning"  Style="width: 140px;height:35px;">Sipariş Detayları</a>
