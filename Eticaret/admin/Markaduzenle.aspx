<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Markaduzenle.aspx.cs" Inherits="Markaduzenle" %>
    ...
    <div class="container-fluid primary-content">
        ...
        <div class="primary-content-heading clearfix">
            ...
            <ul class="breadcrumb pull-left">
                ...
                <li><a href="marklar.aspx">Markalar</a></li>
        ...
        <div id="formsubmitbutton">
            ...
            <button type="button" style="width: 150px;" class="btn btn-success">Yeni Marka Ekle</button>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="genel">
                        <div class="form-group">
                            <label for="text-input1">Marka Adı</label>
                            <asp:TextBox ID="txtMarkaAdi" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:FileUpload ID="fuMarka" runat="server" />
                            <br />
                            <asp:Image ID="imgMarka" runat="server" />
                        </div>
