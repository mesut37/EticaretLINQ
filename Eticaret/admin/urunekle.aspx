<%@ Page Language="C#" AutoEventWireup="true" CodeFile="urunekle.aspx.cs" Inherits="admin_urunekle" %>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="genel">
                                    <div class="form-group">
                                        <label for="text-input1">Ürün Konumlandırması</label>
                                        <br />
                                        <asp:DropDownList runat="server" ID="drpKategoriler" class="chosen-select">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="text-input1">Marka Seçimi</label>
                                        <br />
                                        <asp:DropDownList runat="server" ID="drpMarkalar" class="chosen-select">
                                        </asp:DropDownList>
                                    </div>
                                    <script type="text/javascript">
                                        var config = {
                                ...
                                <div class="tab-pane fade" id="stok">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtStok" Text="10" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label for="text-input1">Alış Fiyatı</label>
                                        <asp:TextBox ID="txtAlisFiyat" class="form-control" Text="10" placeholder="0.00" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label for="text-input1">İndirimli Fiyat</label>
                                        <asp:TextBox ID="txtIndirimliFiyat" class="form-control" Text="10" placeholder="0.00" runat="server"></asp:TextBox>
                                ...
                                <div class="tab-pane fade" id="diger">
                                    ...
                                    <div class="form-group">
                                        <label for="text-input1">Ürün Özellikleri</label>
