    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-Ara"></i></span><input class="form-control multiselect-Ara" type="text"></div>',
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                ...
                if (this.$select.find('option').length >= enableFilterLength) {
                    ...
                    this.$filter.val(this.query).on('click', function(event) {
                        ...
                        clearTimeout(this.AraTimeout);

                        this.AraTimeout = this.asyncFunction($.proxy(function() {
