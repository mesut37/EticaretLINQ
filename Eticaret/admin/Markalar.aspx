<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Markalar.aspx.cs" Inherits="Markalar" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="markalar.aspx">Tüm Markalar</a></li>
                        </ul>
                    ...
                    <a href="Markaekle.aspx" style="width: 150px;" class="btn btn-success">Yeni Marka Ekle</a>
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:Repeater runat="server" ID="rptMarkalar" OnItemCommand="rptMarkalar_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <img src="../Dosyalar/Marka/mini/<%#Eval("Resim")%>" width="50" /></td>
                                                    <td style="text-align: left; padding-left: 8px;width:500px;"><strong><%#Eval("MarkaAdi")%></strong></td>
