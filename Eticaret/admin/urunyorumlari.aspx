<%@ Page Language="C#" AutoEventWireup="true" CodeFile="urunyorumlari.aspx.cs" EnableEventValidation="false" Inherits="admin_urunyorumlari" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="urunyorumlari.aspx">Tüm Yorumları</a></li>
                        </ul>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptYorumlar" OnItemCommand="rptYorumlar_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="text-align: left; padding-left: 8px;"><%#Eval("Ad")%> <%#Eval("Soyad")%></td>
                                                    <td><%#Eval("Email").ToString()%></td>
                                                    <td class="center"><%#Eval("Telefon")%></td>

                                                    <td class="center"><%#yorumKisalt(Eval("Yorum").ToString())%></td>
                                                    <td><%#Eval("EklenmeTarihi").ToString()%></td>
                                                    <td class="center">
                                                        <a href="yorumdetay.aspx?ID=<%#Eval("ID")%>&uyeID=<%#Eval("UyeID")%>" style="width: 100px;" class="btn btn-warning sil">Detay</a>
                                                    ...
                                                    <td>
                                                        <a href="uyedetay.aspx?ID=<%#Eval("uyeID")%>" style="width: 100px;" class="btn btn-warning sil">Üye Detay</a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
