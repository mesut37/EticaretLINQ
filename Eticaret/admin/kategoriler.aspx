<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="kategoriler.aspx.cs" Inherits="kategoriler" %>
                ...
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li><a href="kategoriler.aspx">Tüm Kategoriler</a></li>
                        </ul>
                    ...
                    <!-- END PRIMARY CONTENT HEADING -->
                       <a href="Kategoriekle.aspx" style="width: 150px;" class="btn btn-success">Yeni Kategori Ekle</a>
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    <thead>
                                        <tr>
                                            <th>Resim</th>
                                            <th style="width: 350px;">Kategori Adı</th>
                                            <th>Kategorisi</th>
                                            <th>Sıra</th>
                                            <th>Durum</th>
                                            <th>İşlem</th>
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptKategoriler" OnItemCommand="rptKategoriler_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <img src="../Dosyalar/Kategori/mini/<%#Eval("Resim")%>" width="60" /></td>
                                                    <td style="text-align: left; padding-left: 8px;"><strong><%#Eval("KategoriAdi")%></strong></td>
                                                    <td><%#ustKategori(Eval("AltID").ToString())%></td>
