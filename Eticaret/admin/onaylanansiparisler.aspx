<%@ Page Language="C#" AutoEventWireup="true" CodeFile="onaylanansiparisler.aspx.cs" Inherits="admin_onaylanansiparisler" %>
            ...
            <div id="col-right" class="col-right ">
                <div class="container-fluid primary-content">
                    ...
                    <div class="primary-content-heading clearfix">
                        <h2>Onaylanan Siparişler</h2>
                        <ul class="breadcrumb pull-left">
                            <li><i class="icon ion-home"></i><a href="default.aspx">Anasayfa</a></li>
                            <li><a href="siparisler.aspx">Onaylanan Siparişler</a></li>
                        </ul>
                    ...
                    <div class="widget">
                        <div class="widget-header clearfix">
                            <h3><i class="icon ion-android-keypad"></i>
                                <span>Onaylanan Siparişler</span>
                            </h3>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
                                    ...
                                    <tbody>
                                        <asp:Repeater runat="server" ID="rptSiparisler" OnItemCommand="rptSiparisler_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <a href="siparisdetay.aspx?ID=<%#Eval("ID")%>" style="width: 100px; height: 35px;" class="btn btn-warning">Detay</a>
