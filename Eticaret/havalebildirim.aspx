<%@ Page Language="C#" AutoEventWireup="true" CodeFile="havalebildirim.aspx.cs" Inherits="havalebildirim" %>
                    ...
                    <asp:Repeater runat="server" ID="rptSiparisler">
                        <ItemTemplate>
                            <div class="ListemItem satir">
                                ...
                                <div class="line2"><%#(Convert.ToInt32(Eval("Onay")) == 1) ? "Var" : "Yok"%></div>
                                <div class="line3"><%#string.Format("{0:c}",Eval("Tutar"))%></div>
                                <div class="line4"><%#Eval("Durum")%></div>
                                <div class="line5"><%#Eval("KargoAdi")%></div>
                                <div class="line6">
                                    <a href="/havaleformu/<%#Eval("ID")%>%>" style="color:#2a80b9;font-size:13px; text-decoration: none;">Havale Bildirim Formu <img src="/CustomCss/images/havale.png" width="15" /> </a>
                                </div>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
