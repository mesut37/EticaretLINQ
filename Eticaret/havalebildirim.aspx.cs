...
public partial class havalebildirim : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                var siparisler = from u in db.ETICARET_Siparis.Where(m => m.UyeID == Convert.ToInt32(Session["UyeID"]) & m.OdemeSekli == "Havale / EFT")
